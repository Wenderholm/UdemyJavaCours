package com.company.InputOutput.fileReader;
...
//        NOW READ THE EXITS
        try(Scanner scanner = new Scanner(new BufferedReader(new FileReader("directions_big.txt")))) {
            scanner.useDelimiter(",");
            while (scanner.hasNextLine()) {
//                WYKORZYSTANIE BUFFERREADERA Z SKIPEM
//                int loc = scanner.nextInt();
//                scanner.skip(scanner.delimiter());
...
//                WYKORZYTANIE ODCZYTYWANIE LINI PO LINI Z URZYCIEM TABLICY STRING
